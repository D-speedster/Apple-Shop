            ...
            <div className="container">
                    ...
                    <div className="FooterBoxText container">
                        <div className="col pe-5">
                            <div className="d-flex">
                                <i className="fab fa-apple" style={{ fontSize: 35, paddingLeft: 10, color: "#FFF" }} />
                ...
                <div className="container">
                    <h5 style={{ paddingTop: 6, paddingRight: 10, color: "#FFFF" }}>
                        اپلچی مرکز خرید و فروش محصولات اپل
                    </h5>
                </div>
                ...
                <div className="row list-footer mt-5 mb-5">
                    ...
                    <div className="col-lg-2 col-md-4">
                        ...
                        <ul>
                            <li className='col'><i className="pe-2 fab fa-instagram" />اینستاگرام</li>
                            <li className='col'><i className="pe-2 fab fa-telegram" />تلگرام</li>
                            <li className='col'><i className="pe-2 fab fa-youtube" />یوتیوب</li>
                            <li className='col'><i className="pe-2 fab fa-facebook" />فیسبوک</li>
                            <li className='col'><i className="pe-2 fab fa-whatsapp" />واتس اپ</li>
                        </ul>
                    </div>
                    <div className="col-lg-2 col-md-4 d-lg-block d-md-blcok d-none">
                        <ul className="d-flex namad-Footer">
                            <li><img src="/img/namad.png" alt="نماد" /></li>
                            <li><img src="/img/samandehi.png" alt="ساماندهی" /></li>
                            <li><img src="/img/download-removebg-preview.png" alt="نماد" /></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 d-blcok">
                        <ul className='nav justify-content-between mt-3'>
                            <li style={{ color: "#c6c6cc" }}>اپلچی</li>
                            <li style={{ color: "#c6c6cc" }}>مقررات</li>
                            <li style={{ color: "#c6c6cc" }}>حریم خصوصی</li>
                        </ul>
                    </div>
                </div>
            </div>
