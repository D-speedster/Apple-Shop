            ...
            <div className="container">
                ...
                <div className="row justify-content-between">
                    <div className="col-lg-3 col-12">
                        <div className="card mb-0 col-12">
                            <div className="card-header">
                                <img src="/img/blog-2.jpg" className="img-fluid" alt="Blog" />
                            </div>
                        ...
                        <div className="card">
                            <div className="card-header">
                                <img src="/img/blog-1.jpg" className="img-fluid" alt="Blog" />
                            </div>
                            <div className="card-body">
                    ...
                    <div className="col-lg-6 col-12 center-Side">
                        <img src="/img/blog-big.jpg" alt="Main Blog" />
                    ...
                    <div className="col-lg-3 col-12">
                        <div className="card mb-0">
                            <div className="card-header">
                                <img src="/img/blog-3.jpg" className="img-fluid" alt="Blog" />
                            </div>
                            <div className="card-body">
                        ...
                        <div className="card">
                            <div className="card-header">
                                <img src="/img/blog-4.jpg" className="img-fluid" alt="Blog" />
                            </div>
                            <div className="card-body">
